...
class ProperMotionStats():
    ...
    def fill_histo(self, bg_pmra, bg_pmdec, bg_parallax, q_pix, bins_pix, q_bin_pix, bg_G, q_bin_G, q_bil, q_bin_bil, prob_dist):
        '''
        ...
        hist_parallax = sp.stats.binned_statistic_dd([q_bil, bg_G, q_pix],np.transpose(prob_dist) * bg_parallax, bins=[self.bins_bil, self.bins_G, bins_pix], statistic='sum')[0] #sum first in each bin
        ...
        return hist_prob, hist_pmra, hist_pmdec, hist_parallax, hist_pmra_var, hist_pmdec_var, hist_pmradec_var, hist_parallax_var    
    
    
    def get_stars_stats(self, hist_prob, hist_pmra, hist_pmdec, hist_parallax, hist_pmra_var, hist_pmdec_var, hist_pmradec_var, hist_parallax_var, q_bin_bil, q_bin_G, q_bin_pix, prob_dist):
        '''
        ...
        hist_pmra[hist_prob < self.th_count] = np.nan; hist_pmdec[hist_prob < self.th_count] = np.nan; hist_parallax[hist_prob < self.th_count] = np.nan
        ...
        hist_parallax_var[hist_prob < self.th_count] = np.nan
        ...
        return tab_mean_pmra, tab_mean_pmdec, tab_mean_parallax, tab_var_pmra, tab_var_pmdec, tab_var_pmradec, tab_var_parallax
    ...
    def compute_stats(self, df_fore, df_back, iter_n, final_call=False):
        ...
        hist_prob, hist_pmra, hist_pmdec, hist_parallax, hist_pmra_var, hist_pmdec_var, hist_pmradec_var, hist_parallax_var = self.fill_histo(df_back['pmra'].to_numpy(), df_back['pmdec'].to_numpy(), df_back['parallax'].to_numpy(),
                                                                                                                                              q_pix, bins_pix, q_bin_pix, bg_G, q_bin_G, q_bil, q_bin_bil, prob_dist)
        
        tab_mean_pmra, tab_mean_pmdec, tab_mean_parallax, tab_var_pmra, tab_var_pmdec, tab_var_pmradec, tab_var_parallax = self.get_stars_stats(hist_prob, hist_pmra, hist_pmdec, hist_parallax, 
                                                                                                                                                hist_pmra_var, hist_pmdec_var, hist_pmradec_var, hist_parallax_var,
        ...
        if final_call==False: # remove outliers
            ...
            not_outlier = ( (mu_over_sigma_sq < self.n_sigma_out**2) & (parallax_sub**2/tab_var_parallax < self.n_sigma_out**2) )
